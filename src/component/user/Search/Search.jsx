...
export default function Search() {
  ...
  useEffect(() => {
    const fetchSearchCourses = async () => {
      try {
        ...
        // const response = await axiosClient.get(
        //   `/courses/search/a?sort=learn-most&hasPromotion=true&pageNumber=1&pageSize=6`
        // );
        console.log('response: ', response);

        // dùng cái này để kiểm tra một số chức năng chờ api phía trên sửa xong
        // const response = await axiosClient.get(
        //   `/courses/filter-courses?categoryId=12&sort=${selectedOption}${filterOption}&page=${currentPage}&size=6`
        // );
  ...
  }, [title, selectedOption, filterOption, currentPage]);
  ...
  return (
    <div>
      ...
      <div className="container-fluid col-md-10">
        <p className="fw-bold fs-3 mb-4">{totalResult} kết quả cho "{title}"</p>
        <div className="w-full row content-center">
          <div className="col-3">
            ...
            <button
              className={`btn ${
                ratingFilter[5] === true ? "btn-success" : "btn-light"
              }`}
            ...
            <button
              className={`btn ${
                ratingFilter[4] === true ? "btn-success" : "btn-light"
              }`}
            ...
            <button
              className={`btn ${
                ratingFilter[3] === true ? "btn-success" : "btn-light"
              }`}
            ...
            <button
              className={`btn ${
                ratingFilter[2] === true ? "btn-success" : "btn-light"
              }`}
            ...
            <button
              className={`btn ${
                ratingFilter[1] === true ? "btn-success" : "btn-light"
              }`}
